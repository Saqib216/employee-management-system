...
const variants = {
    ...
    ghost:    'px-4 py-2 text-secondary border border-secondary rounded-lg cursor-pointer hover:border-primary hover:text-surface transition-all duration-300 font-semibold hover:bg-primary active:bg-secondary',
}
